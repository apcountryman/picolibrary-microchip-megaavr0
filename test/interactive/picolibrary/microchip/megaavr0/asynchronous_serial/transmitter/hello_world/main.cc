...
/**
 * \file
 * \brief picolibrary::Microchip::megaAVR0::Asynchronous_Serial::Transmitter hello world
...
/**
 * \brief Execute the picolibrary::Microchip::megaAVR0::Asynchronous_Serial::Transmitter
