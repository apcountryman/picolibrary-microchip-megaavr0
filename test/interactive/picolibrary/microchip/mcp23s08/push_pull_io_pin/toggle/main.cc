...
/**
 * \file
 * \brief picolibrary::Microchip::MCP23S08::Push_Pull_IO_Pin toggle interactive test
 *        program.
 */
...
/**
 * \brief Execute the picolibrary::Microchip::MCP23S08::Push_Pull_IO_Pin toggle
 *        interactive test.
 *
 * \return N/A
 */
int main() noexcept
{
    ...
    toggle<::picolibrary::Microchip::MCP23S08::Push_Pull_IO_Pin>(
        ...
        GPIO_Output_Pin_Device_Selector<Active_Low_IO_Pin<::picolibrary::Microchip::megaAVR0::GPIO::Push_Pull_IO_Pin<PORT>>>{
