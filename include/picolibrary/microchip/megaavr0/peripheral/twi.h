...
class TWI {
  public:
     ...
     * - (FIELD7)
     */
    class Foo : public Register<std::uint8_t> {
      public:
        /**
         * \brief Field sizes.
         */
        struct Size {
            static constexpr auto FIELD0 = std::uint_fast8_t{ 1 }; ///< FIELD0.
            static constexpr auto FIELD1 = std::uint_fast8_t{ 1 }; ///< FIELD1.
            static constexpr auto FIELD2 = std::uint_fast8_t{ 1 }; ///< FIELD2.
            static constexpr auto FIELD3 = std::uint_fast8_t{ 1 }; ///< FIELD3.
            static constexpr auto FIELD4 = std::uint_fast8_t{ 1 }; ///< FIELD4.
            static constexpr auto FIELD5 = std::uint_fast8_t{ 1 }; ///< FIELD5.
            static constexpr auto FIELD6 = std::uint_fast8_t{ 1 }; ///< FIELD6.
            static constexpr auto FIELD7 = std::uint_fast8_t{ 1 }; ///< FIELD7.
        };
         ...
         */
        struct Bit {
            static constexpr auto FIELD0 = std::uint_fast8_t{}; ///< FIELD0.
            static constexpr auto FIELD1 = std::uint_fast8_t{ FIELD0 + Size::FIELD0 }; ///< FIELD1.
            static constexpr auto FIELD2 = std::uint_fast8_t{ FIELD1 + Size::FIELD1 }; ///< FIELD2.
            static constexpr auto FIELD3 = std::uint_fast8_t{ FIELD2 + Size::FIELD2 }; ///< FIELD3.
            static constexpr auto FIELD4 = std::uint_fast8_t{ FIELD3 + Size::FIELD3 }; ///< FIELD4.
            static constexpr auto FIELD5 = std::uint_fast8_t{ FIELD4 + Size::FIELD4 }; ///< FIELD5.
            static constexpr auto FIELD6 = std::uint_fast8_t{ FIELD5 + Size::FIELD5 }; ///< FIELD6.
            static constexpr auto FIELD7 = std::uint_fast8_t{ FIELD6 + Size::FIELD6 }; ///< FIELD7.
        };
         ...
         */
        struct Mask {
            static constexpr auto FIELD0 = mask<std::uint8_t>( Size::FIELD0, Bit::FIELD0 ); ///< FIELD0.
            static constexpr auto FIELD1 = mask<std::uint8_t>( Size::FIELD1, Bit::FIELD1 ); ///< FIELD1.
            static constexpr auto FIELD2 = mask<std::uint8_t>( Size::FIELD2, Bit::FIELD2 ); ///< FIELD2.
            static constexpr auto FIELD3 = mask<std::uint8_t>( Size::FIELD3, Bit::FIELD3 ); ///< FIELD3.
            static constexpr auto FIELD4 = mask<std::uint8_t>( Size::FIELD4, Bit::FIELD4 ); ///< FIELD4.
            static constexpr auto FIELD5 = mask<std::uint8_t>( Size::FIELD5, Bit::FIELD5 ); ///< FIELD5.
            static constexpr auto FIELD6 = mask<std::uint8_t>( Size::FIELD6, Bit::FIELD6 ); ///< FIELD6.
            static constexpr auto FIELD7 = mask<std::uint8_t>( Size::FIELD7, Bit::FIELD7 ); ///< FIELD7.
        };
