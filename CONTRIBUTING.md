# Contributing to picolibrary-microchip-megaavr0
The following is a set of guidelines for contributing to `picolibrary-microchip-megaavr0`.
...
- The `picolibrary-microchip-megaavr0` version (Git commit SHA)
