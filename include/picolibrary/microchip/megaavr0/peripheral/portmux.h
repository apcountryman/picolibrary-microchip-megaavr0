...
class PORTMUX {
  public:
    ...
    /**
     * \brief EVSYS routing configuration.
     */
    enum class EVSYS_Route : std::uint_fast8_t {
        DEFAULT   = 0x0, ///< Default route.
        ALTERNATE = 0x1, ///< Alternate route.
    };

    /**
     * \brief CCL routing configuration.
     */
    enum class CCL_Route : std::uint_fast8_t {
        DEFAULT   = 0x0, ///< Default route.
        ALTERNATE = 0x1, ///< Alternate route.
    };
    ...
    /**
     * \brief TCA routing configuration.
     */
    enum class TCA_Route : std::uint8_t {
        PORTA = 0x0 << TCAROUTEA::Bit::TCA0, ///< PORTA.
        PORTB = 0x1 << TCAROUTEA::Bit::TCA0, ///< PORTB.
        PORTC = 0x2 << TCAROUTEA::Bit::TCA0, ///< PORTC.
        PORTD = 0x3 << TCAROUTEA::Bit::TCA0, ///< PORTD.
        PORTE = 0x4 << TCAROUTEA::Bit::TCA0, ///< PORTE.
        PORTF = 0x5 << TCAROUTEA::Bit::TCA0, ///< PORTF.
    };

    /**
     * \brief TCB routing configuration.
     */
    enum class TCB_Route : std::uint_fast8_t {
        DEFAULT   = 0x0, ///< Default route.
        ALTERNATE = 0x1, ///< Alternate route.
    };
