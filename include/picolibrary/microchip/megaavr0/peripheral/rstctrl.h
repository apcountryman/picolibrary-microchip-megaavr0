...
class RSTCTRL {
  public:
    /**
     * \brief Reset Flag (RSTFR) register.
     *
    ...
    /**
     * \brief Software Reset (SWRR) register.
     *
     * This register has the following fields:
...
/**
 * \brief Microchip megaAVR 0-series Reset Controller (RSTCTRL) peripheral instance.
 *
 * \tparam INSTANCE_ADDRESS The address of the RSTCTRL instance.
 */
template<std::uintptr_t INSTANCE_ADDRESS>
using RSTCTRL_Instance = Instance<RSTCTRL, INSTANCE_ADDRESS>;
